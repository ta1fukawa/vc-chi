...
class SSIMLoss(Module):
    def __init__(self, kernel_size: int = 11, sigma: float = 1.5, channel: int = 3) -> None:
        ...
        self.gaussian_kernel = self._create_gaussian_kernel(self.kernel_size, self.sigma, self.channel)
    ...
    def _create_gaussian_kernel(self, kernel_size: int, sigma: float, channel: int) -> Tensor:
